#!/bin/bash
#SBATCH --job-name=test2_np48
#SBATCH --nodes=1
#SBATCH --ntasks-per-node=48
#SBATCH --time=00:20:00
#SBATCH --output=/g100_work/uBS26_MatGer/dealii-internodes/reproduce/results/scalability_galileo100-smoke/test2_np48.log
...
module load cmake
srun /g100_work/uBS26_MatGer/dealii-internodes/build/examples/coupled_diffusion/coupled_diffusion /g100_work/uBS26_MatGer/dealii-internodes/reproduce/results/scalability_galileo100-smoke/test2_np48.prm
