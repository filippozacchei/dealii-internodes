#!/bin/bash
#SBATCH --job-name=test3_np96
#SBATCH --nodes=2
#SBATCH --ntasks-per-node=48
#SBATCH --time=00:20:00
#SBATCH --output=/g100_work/uBS26_MatGer/dealii-internodes/reproduce/results/scalability_galileo100-smoke/test3_np96.log
...
module load cmake
srun /g100_work/uBS26_MatGer/dealii-internodes/build/examples/coupled_diffusion/coupled_diffusion /g100_work/uBS26_MatGer/dealii-internodes/reproduce/results/scalability_galileo100-smoke/test3_np96.prm
