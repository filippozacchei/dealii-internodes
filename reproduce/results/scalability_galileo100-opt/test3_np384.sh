#!/bin/bash
#SBATCH --job-name=test3_np384
#SBATCH --nodes=8
#SBATCH --ntasks-per-node=48
#SBATCH --time=00:30:00
#SBATCH --output=/g100_work/uBS26_MatGer/dealii-internodes/reproduce/results/scalability_galileo100-opt/test3_np384.log
...
module load cmake
srun /g100_work/uBS26_MatGer/dealii-internodes/build/examples/coupled_diffusion/coupled_diffusion /g100_work/uBS26_MatGer/dealii-internodes/reproduce/results/scalability_galileo100-opt/test3_np384.prm
