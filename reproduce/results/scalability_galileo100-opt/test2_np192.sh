...
#SBATCH --output=/g100_work/uBS26_MatGer/dealii-internodes/reproduce/results/scalability_galileo100-opt/test2_np192.log
...
module load cmake
srun /g100_work/uBS26_MatGer/dealii-internodes/build/examples/coupled_diffusion/coupled_diffusion /g100_work/uBS26_MatGer/dealii-internodes/reproduce/results/scalability_galileo100-opt/test2_np192.prm
